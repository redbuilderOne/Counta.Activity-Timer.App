...
//        return nonDeletedActivities().count
    }

    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        show(ActivityDetailedViewController(activity:  ActivitiesObject.arrayOfActivities[indexPath.row]), sender: self)

//        show(ActivityDetailedViewController(activity: nonDeletedActivities()[indexPath.row]), sender: self)
    }
...
//        let object = nonDeletedActivities()[indexPath.row]
